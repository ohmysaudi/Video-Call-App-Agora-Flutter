...
class NotificationHandler{
  ...
  static void initNotification({required BuildContext context,required DidReceiveNotificationResponseCallback selectNotificationCallback}){ //customize
    myContext = context;
    ...
    flutterLocalNotificationPlugin.initialize(initSetting,onDidReceiveNotificationResponse: selectNotificationCallback);
