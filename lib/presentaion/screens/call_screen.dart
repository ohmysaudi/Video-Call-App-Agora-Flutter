...
class _CallScreenState extends State<CallScreen> {
  ...
  void initState() {
    ...
    if(!widget.isReceiver){ //Caller
      _callCubit.initAgoraAndJoinChannel(channelToken: widget.callModel.token!,channelName: widget.callModel.channelName!, isVideo: widget.callModel.isVideo?? false, isCaller:true);
    }else{ //Receiver
              ...
              body: Container(
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image:
                    AssetImage("assets/images/caller_bg.jpg"),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Stack(
                    ...
                    cubit.remoteUid == null
                        ...
                        : Stack(
                            children: [
                              Center(
                                child:
                                    _remoteVideo(remoteUserId: cubit.remoteUid!),
                              ),
                              const Align(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          if (widget.isReceiver) {
                                            ...
                                            _callCubit.updateCallStatusToCancel(
                                                callId: widget.callModel.id);
                                          }
                                        },
                                        child: Container(
