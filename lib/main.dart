...
import 'package:agoraapp/routes.dart';
import 'package:agoraapp/services/fcm/firebase_notification_handler.dart';
import 'package:agoraapp/shared/dio_helper.dart';
import 'package:agoraapp/shared/network/cache_helper.dart';
import 'package:agoraapp/shared/theme.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (_) => HomeCubit()..listenToInComingCalls()..getUsersRealTime()..initFcm(context)..updateFcmToken(uId:  CacheHelper.getString(key: 'uId')),
        ),
      ],
      child: MaterialApp(
